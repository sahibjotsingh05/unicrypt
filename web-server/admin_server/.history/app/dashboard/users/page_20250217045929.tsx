	...
	const handleUpdateAccess = async (
		...
		try {
			...
			const updateResponse = await axios.post(
				`/api/proxy/updateUserAssets/${username}?t=${timestamp}`,
				{
			...
			console.error("Update error:", error);
			toast.error("Failed to update access. Please refresh the page.");
			// Force a refresh anyway to ensure sync
			await fetchData();
		} finally {
			setUpdating(false);
		}
